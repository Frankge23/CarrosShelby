...
<body>
  ...
  <div class="barra">
     ...
     <!--  <div class="contenedor-barra contenedor">

         < <a href="index.html" class="nombre-empresa">Exhibición de Carros<span>Shelby</span></a>

            <nav>

                <a href="anuncios.html">Coches</a>
    ...
    <div class="contenedor-menu-movil">
        ...
        <nav class="menu-movil">
            ...
            <label for="menu"><img src="wwwroot/img/bars-solid.svg" alt="menu"></label>

            <ul>

                <li><a href="anuncios.html">Coches</a></li>
            ...
            <div class="contenedor-anuncios">
                ...
                <div class="anuncio margin-top">
                    ...
                    <div class="contenedor-img">
                        ...
                        <img src="wwwroot/img/Ferrari812.jpg" alt="Ferrari 812 Superfast">

                    </div>

                    <div>
                        <h3>Ferrari 812 Superfast</h3>
                        <p>El heredero directo del primer Ferrari</p>
                        <a href="https://www.ferrari.com/es-EC/auto/812-superfast" target="_blank">Más información</a>
                ...
                <div class="anuncio margin-top">
                    ...
                    <div class="contenedor-img">
                        ...
                        <img src="wwwroot/img/McLaren720S.jpg" alt="McLaren 720S">
                    ...
                    <div>
                        ...
                        <a href="https://cars.mclaren.com/es-es/super-series/720s" target="_blank">Más información</a>
        ...
        <div class="barra">
            ...
            <div class="contenedor-barra contenedor footer">
               ...
               <!-- <nav>
                ...
                <p class="copyright">&copy; Copyright 2023 - Todos los Derechos Reservados Shelby</p>
